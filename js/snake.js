  ...
  this.platform = {
    ...
    render: function () {
      setInterval(function () {
        ...
        snakesColor = this._data.snakes.map(function (val) {
          return val._data.color
        });
        foodsColor = this._data.foods.map(function (val) {
          return val.color
        });
        let {
          canv
    ...
    bindData: function () {
      setInterval(function () {
        let {
          ...
          id,
          color
        } = this.platform._data.snakes[0]._data;
        let foods = this.platform._data.foods.map(function (val) {
          return val.position
        });
        let foodsColor = this.platform._data.foods.map(function (val) {
          return val.color
        });
  ...
  (function initData() {
    Config.snakes.map(function (val, index) {
      ...
      let {
        ...
        left,
        right
      } = Config.snakes[index].direction.keydown;
